...
### [P3-2] 5분 결정 사이클 측정 인스트루먼테이션
- 진입→시그널→내러티브→차트→결정 단계별 이벤트 → Vercel Analytics
- **완료 기준**: 7일치 p50/p90 분포 확인 가능

### [P3-3] 시그널 신뢰 배지 표본·임계값 룰 확립
- 표본 N≥30, hit rate≥60% 이상에서만 신뢰 배지 점등, 미달 시 "데이터 누적 중" 표기
- **완료 기준**: 노출 룰 문서화 + 미달 시그널 비노출 테스트
