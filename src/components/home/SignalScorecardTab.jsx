...
const SIGNAL_BOT_NAMES = {
  ...
  whale_exchange_inflow: '고래 거래소 입금',
  whale_exchange_outflow: '고래 거래소 출금',
  whale_stablecoin_inflow: '스테이블코인 입금',
  whale_large_single: '초대형 자금이동',
...
const BOT_CATEGORIES = {
  event: [
    ...
    'volume_anomaly', 'whale_exchange_inflow', 'whale_exchange_outflow',
    'whale_stablecoin_inflow', 'whale_large_single', 'fear_greed_shift',
